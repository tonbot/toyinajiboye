                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 mb-5">
                            <small class="d-inline bg-primary text-dark text-uppercase font-weight-bold px-1">Our Pricing Plan</small>
                            <h1 class="mt-2 mb-3">I Offer Affordable and Flexible Packages</h1>
                            <h4 class="font-weight-normal text-muted mb-4">I offer customised development packages that can be tailored to your specific needs and budget, ensuring that you get the most value for your money. </h4>
